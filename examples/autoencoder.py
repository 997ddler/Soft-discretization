...
train_dataset = DataLoader(datasets.CIFAR10(root='~/data/cifar', train=True, download=True, transform=transform), batch_size=batch_size, shuffle=True)
test_dataset = DataLoader(datasets.CIFAR10(root='~/data/cifar', train=False, download=True, transform=transform), batch_size=batch_size, shuffle=True)
